...
DROP INDEX IF EXISTS RELATIONSHIP_6_FK ON DB_PLAT_SYSTEM.EMPLOYEE;
DROP INDEX IF EXISTS RELATIONSHIP_11_FK ON DB_PLAT_SYSTEM.WORD;
...
DROP TABLE IF EXISTS DB_PLAT_SYSTEM.FUNC_CATEGORY;
