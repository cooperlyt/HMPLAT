CREATE DATABASE IF NOT EXISTS `DB_PLAT_SYSTEM`  DEFAULT CHARACTER SET utf8 ;
...
DROP TABLE DB_PLAT_SYSTEM.REPORT_REPROT_SUBSCRIBE;
DROP TABLE DB_PLAT_SYSTEM.REPORT;
...
DROP TABLE DB_PLAT_SYSTEM.RATE_RATE_SUBSCRIBE;
DROP TABLE DB_PLAT_SYSTEM.RATE;
DROP TABLE DB_PLAT_SYSTEM.FILE_SUBSCRIBE;
DROP TABLE DB_PLAT_SYSTEM.COMPLEX_VAR_SUBSCRIBE;
DROP TABLE DB_PLAT_SYSTEM.RATE_SUBSCRIBE;
DROP TABLE DB_PLAT_SYSTEM.REPORT_SUBSCRIBE;
DROP TABLE DB_PLAT_SYSTEM.SIMPLE_VAR_SUBSCRIBE;
DROP TABLE DB_PLAT_SYSTEM.SIMPLE_VAR_DEFINE;
...
CREATE TABLE DB_PLAT_SYSTEM.RATE
(
	ID VARCHAR(32) NOT NULL COMMENT 'ID',
	NAME VARCHAR(50) NOT NULL COMMENT 'NAME',
...
CREATE TABLE DB_PLAT_SYSTEM.RATE_RATE_SUBSCRIBE
(
...
CREATE TABLE DB_PLAT_SYSTEM.REPORT_REPROT_SUBSCRIBE
(
...
CREATE TABLE DB_PLAT_SYSTEM.COMPLEX_VAR_SUBSCRIBE
(
	ID VARCHAR(32) NOT NULL COMMENT 'ID',
	WF_TASK VARCHAR(32) NOT NULL COMMENT '工作流阶段',
	WF_VER VARCHAR(32) NOT NULL COMMENT '工作流版本',
...
CREATE TABLE DB_PLAT_SYSTEM.RATE_SUBSCRIBE
(
	ID VARCHAR(32) NOT NULL COMMENT 'ID',
	WF_TASK VARCHAR(32) NOT NULL COMMENT '工作流阶段',
	WF_VER VARCHAR(32) NOT NULL COMMENT '工作流版本',
...
CREATE TABLE DB_PLAT_SYSTEM.REPORT_SUBSCRIBE
(
	ID VARCHAR(32) NOT NULL COMMENT 'ID',
	WF_VER VARCHAR(32) NOT NULL COMMENT '工作流版本',
	WF_TASK VARCHAR(32) NOT NULL COMMENT '工作流阶段',
...
CREATE TABLE DB_PLAT_SYSTEM.SIMPLE_VAR_SUBSCRIBE
(
	ID VARCHAR(32) NOT NULL COMMENT 'ID',
	WF_TASK VARCHAR(32) NOT NULL COMMENT '工作流阶段',
	WF_VER VARCHAR(32) NOT NULL COMMENT '工作流版本',
...
CREATE TABLE DB_PLAT_SYSTEM.SIMPLE_VAR_DEFINE
(
	ID VARCHAR(32) NOT NULL COMMENT 'ID',
	TITLE VARCHAR(50) NOT NULL COMMENT 'TITLE',
...
ALTER TABLE DB_PLAT_SYSTEM.REPORT_REPROT_SUBSCRIBE
...
ALTER TABLE DB_PLAT_SYSTEM.RATE_RATE_SUBSCRIBE
	ADD FOREIGN KEY (RATE_ID)
	REFERENCES DB_PLAT_SYSTEM.RATE (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
ALTER TABLE DB_PLAT_SYSTEM.RATE_RATE_SUBSCRIBE
	...
	REFERENCES DB_PLAT_SYSTEM.RATE_SUBSCRIBE (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
ALTER TABLE DB_PLAT_SYSTEM.REPORT_REPROT_SUBSCRIBE
	...
	REFERENCES DB_PLAT_SYSTEM.REPORT_SUBSCRIBE (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;


ALTER TABLE DB_PLAT_SYSTEM.SIMPLE_VAR_SUBSCRIBE
	ADD FOREIGN KEY (VARIABLE)
	REFERENCES DB_PLAT_SYSTEM.SIMPLE_VAR_DEFINE (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
ALTER TABLE DB_PLAT_SYSTEM.EMPLOYEE
	...
	REFERENCES DB_PLAT_SYSTEM.PERSON (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
ALTER TABLE DB_PLAT_SYSTEM.COMPLEX_VAR_SUBSCRIBE
...
ALTER TABLE DB_PLAT_SYSTEM.RATE_SUBSCRIBE
...
ALTER TABLE DB_PLAT_SYSTEM.REPORT_SUBSCRIBE
	ADD FOREIGN KEY (BUSINESS_DEFINE)
	REFERENCES DB_PLAT_SYSTEM.BUSINESS_DEFINE (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
...
ALTER TABLE DB_PLAT_SYSTEM.SIMPLE_VAR_DEFINE
