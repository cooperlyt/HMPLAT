...
(
	...
	PYCODE VARCHAR(100) COMMENT 'PYCODE',
	VERSION INT NOT NULL COMMENT 'VERSION',
...
(
	ID VARCHAR(32) NOT NULL COMMENT 'ID',
	NAME VARCHAR(50) NOT NULL COMMENT '名称',
	PYCODE VARCHAR(50) COMMENT 'PYCODE',
	VERSION INT NOT NULL COMMENT 'VERSION',
	ATTACH_ID VARCHAR(32) COMMENT 'ATTACH_ID',
	DESTROYED BOOLEAN NOT NULL COMMENT '注销',
...
(
	...
	HOUSE_NUMBER VARCHAR(50) NOT NULL COMMENT '房屋编号',
	BUILD_NAME VARCHAR(50) NOT NULL COMMENT '楼幢名称',
	STRUCTURE VARCHAR(32) NOT NULL COMMENT '结构',
	ADDRESS VARCHAR(200) COMMENT '地址',
	AREA DECIMAL(18,3) NOT NULL COMMENT '面积',
	MEMO VARCHAR(200) COMMENT '备注',
...
(
	...
	VERSION INT COMMENT 'VERSION',
	CREATE_TIME TIMESTAMP NOT NULL COMMENT '创建时间',
	COMPLETE_DATE DATETIME COMMENT '竣工时间',
...
(
	...
	HAVE_DOWN_ROOM BOOLEAN NOT NULL COMMENT '是否有半地下室',
	PRIMARY KEY (ID)
...
(
	...
	NAME VARCHAR(100) NOT NULL UNIQUE COMMENT '楼幢名称',
	COMPLETE_DATE VARCHAR(6) COMMENT '峻工日期',
	PROJECT_ID VARCHAR(32) NOT NULL COMMENT '项目ID',
	DOOR_NO VARCHAR(10) COMMENT '门牌号',
	UNINT_COUNT INT COMMENT '单元数',
	FLOOR_COUNT INT NOT NULL COMMENT '总层数',
	ADDRESS VARCHAR(100) COMMENT '楼幢地址',
...
(
	...
	LOCK_STATUS VARCHAR(20) NOT NULL COMMENT '冻结',
	PAY_WXZJ BOOLEAN NOT NULL COMMENT '是否缴效维修资金',
	MASTER_OWNER VARCHAR(32) COMMENT 'MASTER_OWNER',
