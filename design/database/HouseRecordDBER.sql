...
DROP TABLE IF EXISTS HOUSE_OWNER_RECORD.PREPARE_OWNER;
...
DROP TABLE IF EXISTS HOUSE_OWNER_RECORD.HOUSE_CARD_PATCH;
...
(
	...
	PREPARE_OWNER VARCHAR(32),
	CONSTRAINT PK_HOUSE PRIMARY KEY (ID)
) ENGINE = InnoDB DEFAULT CHARACTER SET utf8;


CREATE TABLE HOUSE_OWNER_RECORD.HOUSE_CARD_PATCH
(
	-- 倒库导入原库的NO
	BUSINESS VARCHAR(32) NOT NULL COMMENT '倒库导入原库的NO',
	CARD VARCHAR(32) NOT NULL,
	PRIMARY KEY (BUSINESS, CARD)
) ENGINE = InnoDB DEFAULT CHARACTER SET utf8;
...
CREATE TABLE HOUSE_OWNER_RECORD.PREPARE_OWNER
(
	ID VARCHAR(32) NOT NULL,
	NAME VARCHAR(50) NOT NULL,
	ID_TYPE VARCHAR(32) NOT NULL,
...
ALTER TABLE HOUSE_OWNER_RECORD.HOUSE_CARD_PATCH
	ADD FOREIGN KEY (CARD)
	REFERENCES HOUSE_OWNER_RECORD.MAKE_CARD (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
...
ALTER TABLE HOUSE_OWNER_RECORD.PREPARE_OWNER
	ADD FOREIGN KEY (CARD)
	REFERENCES HOUSE_OWNER_RECORD.MAKE_CARD (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
...
ALTER TABLE HOUSE_OWNER_RECORD.HOUSE
	ADD FOREIGN KEY (PREPARE_OWNER)
	REFERENCES HOUSE_OWNER_RECORD.PREPARE_OWNER (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
