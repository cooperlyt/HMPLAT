...
(
	ID VARCHAR(32) NOT NULL,
	HOUSE_CODE VARCHAR(32) NOT NULL UNIQUE,
...
(
	...
	ID VARCHAR(32) NOT NULL,
	OWNER_CARD VARCHAR(32) NOT NULL,
...
(
	...
	CREATE_EMP_NAME VARCHAR(50) NOT NULL,
	CREATE_EMP_CODE VARCHAR(32) NOT NULL,
	PRIMARY KEY (ID)
) ENGINE = InnoDB DEFAULT CHARACTER SET utf8;
...
(
	...
	HOUSE_RECORD VARCHAR(32) NOT NULL,
	PRIMARY KEY (ID)
) ENGINE = InnoDB DEFAULT CHARACTER SET utf8;
