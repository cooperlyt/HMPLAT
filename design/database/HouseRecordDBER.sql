...
DROP INDEX HOUSE_BUSINESS_SEARCH_BY_KEY ON HOUSE_OWNER_RECORD.BUSINESS_HOUSE;
DROP INDEX HOUSE_RECORD_SEARCH_BY_KEY ON HOUSE_OWNER_RECORD.HOUSE_RECORD;
DROP INDEX OWNER_BUSINESS_REG_TIME_INDEX ON HOUSE_OWNER_RECORD.OWNER_BUSINESS;
DROP INDEX OWNER_BUSINESS_SEARCH_BY_KEY ON HOUSE_OWNER_RECORD.OWNER_BUSINESS;
...
DROP TABLE IF EXISTS HOUSE_OWNER_RECORD.RECORD_LOCAL;
DROP TABLE IF EXISTS HOUSE_OWNER_RECORD.BUSINESS_FILE;
DROP TABLE IF EXISTS HOUSE_OWNER_RECORD.SALE_SHOW_CHECK;
DROP TABLE IF EXISTS HOUSE_OWNER_RECORD.HOUSE_AND_RECORD;
...
(
	...
	SEARCH_KEY VARCHAR(65535) NOT NULL,
...
CREATE INDEX HOUSE_BUSINESS_SEARCH_BY_KEY USING BTREE ON HOUSE_OWNER_RECORD.BUSINESS_HOUSE (SEARCH_KEY ASC);
CREATE INDEX HOUSE_RECORD_SEARCH_BY_KEY USING BTREE ON HOUSE_OWNER_RECORD.HOUSE_RECORD (SEARCH_KEY ASC);
CREATE INDEX OWNER_BUSINESS_REG_TIME_INDEX ON HOUSE_OWNER_RECORD.OWNER_BUSINESS (REG_TIME ASC);
CREATE INDEX OWNER_BUSINESS_SEARCH_BY_KEY USING BTREE ON HOUSE_OWNER_RECORD.OWNER_BUSINESS (SEARCH_KEY ASC);
