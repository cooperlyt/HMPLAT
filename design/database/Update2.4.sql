...
ALTER TABLE DB_PLAT_SYSTEM.BUSINESS_DEFINE CHANGE PICK_BUSINESS_DEFINE_STATUS PICK_BUSINESS_DEFINE_STATUS varchar(100);
...
INSERT HOUSE_OWNER_RECORD.BUILD_POINT (ID, NAME, PERCENT) VALUE ('1','20%',20);
INSERT HOUSE_OWNER_RECORD.BUILD_POINT (ID, NAME, PERCENT) VALUE ('2','25%',25);
INSERT HOUSE_OWNER_RECORD.BUILD_POINT (ID, NAME, PERCENT) VALUE ('3','50%',50);
INSERT HOUSE_OWNER_RECORD.BUILD_POINT (ID, NAME, PERCENT) VALUE ('4','75%',75);
INSERT HOUSE_OWNER_RECORD.BUILD_POINT (ID, NAME, PERCENT) VALUE ('5','95%',95);
...
UPDATE DB_PLAT_SYSTEM.SYSTEM_PARAM set VALUE='2.4' where ID='database_version';