...
SELECT ob.ID as COMPACT_ID,concat(h.HOUSE_CODE, '210682') as HOUSEINFO_ID ,
  ...
  hc.SUM_PRICE as COMPACT_PRICE,h.DEVELOPER_CODE as REALTYDEALER_ID,h.PROJECT_CODE as PROJECT_ID,
  ...
  hc.PROJECT_RSHIP_NUMBER as COMPACT_NAME,'210682' as REGIONCODE,
...
FROM BUSINESS_HOUSE bh LEFT JOIN OWNER_BUSINESS ob on ob.ID = bh.BUSINESS_ID
  ...
  LEFT JOIN HOUSE_CONTRACT hc on hc.ID = bh.ID
...
SELECT islh.SJTS_LOG_ID,
  ob.ID as COMPACT_ID,concat(h.HOUSE_CODE, '210682') as HOUSEINFO_ID ,
                      h.HOUSE_CODE as RIGHTHOUSE_ID, hc.CONTRACT_NUMBER as COMPACT_CODE,
                      IF((ob.STATUS = 'COMPLETE'),6000 ,4000) as COMPACT_STATUS,
                      IF((hc.TYPE = 'NOW_SELL'),3001,2001) as COMPACT_TYPE,
                      hc.SUM_PRICE as COMPACT_PRICE,h.DEVELOPER_CODE as REALTYDEALER_ID,h.PROJECT_CODE as PROJECT_ID,
