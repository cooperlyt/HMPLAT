...
BEGIN
  ...
  IF NEW.HOUSE_STATUS = 'DESTROY' THEN
    ...
    INSERT HOUSE_OWNER_RECORD.I_SJTS_LOG_HISTORY(HOUSE_CODE,TABLE_NAME,STATE,OUT_HOUSE_ID) VALUES(NEW.HOUSE_CODE,'A',1,concat(NEW.HOUSE_CODE,'210681')),(NEW.HOUSE_CODE,'B',1,concat(NEW.HOUSE_CODE,'210681'));
  ELSE
    DELETE FROM HOUSE_OWNER_RECORD.I_SJTS_LOG_HISTORY WHERE HOUSE_CODE = NEW.HOUSE_CODE and STATE = 0;

    INSERT HOUSE_OWNER_RECORD.I_SJTS_LOG_HISTORY(HOUSE_CODE,TABLE_NAME,STATE,OUT_HOUSE_ID) VALUES(NEW.HOUSE_CODE,'A',0,concat(NEW.HOUSE_CODE,'210681')),(NEW.HOUSE_CODE,'B',0,concat(NEW.HOUSE_CODE,'210681')),(NEW.HOUSE_CODE,'C',0,concat(NEW.HOUSE_CODE,'210681'));
  END IF;
...
SELECT islh.SJTS_LOG_ID, hr.HOUSE_CODE as HOUSESYQDJ_ID,bh.BUSINESS_ID as DATASEQ,concat(hr.HOUSE_CODE, '210681') as HOUSEINFO_ID,hr.HOUSE_CODE as RIGHTHOUSE_ID,
  '210681' as REGIONCODE, hr.HOUSE_CODE as HOUSENUM,bh.BUSINESS_ID as RIGHTACCEPT_ID,null OWNERSHIPGETTYPE,
