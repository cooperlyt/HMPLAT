...
CREATE TABLE HOUSE_INFO.SELL_PROXY_PERSON
(
	ID VARCHAR(32) NOT NULL,
	CREDENTIALS_TYPE VARCHAR(32) NOT NULL,
	CREDENTIALS_NUMBER VARCHAR(100) NOT NULL,
...
ALTER TABLE HOUSE_INFO.SELL_PROXY_PERSON
	ADD FOREIGN KEY (ID)
REFERENCES HOUSE_INFO.OLD_HOUSE_SELL (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
...
ALTER TABLE HOUSE_OWNER_RECORD.CONTRACT_OWNER MODIFY ID_NO VARCHAR(100);
ALTER TABLE HOUSE_OWNER_RECORD.BUSINESS_PERSION MODIFY ID_NO VARCHAR(100);
ALTER TABLE HOUSE_OWNER_RECORD.BUSINESS_POOL MODIFY ID_NO VARCHAR(100);
ALTER TABLE HOUSE_OWNER_RECORD.BUSINESS_OWNER MODIFY ID_NO VARCHAR(100);


INSERT INTO DB_PLAT_SYSTEM.SYSTEM_PARAM(ID,TYPE,VALUE,MEMO) VALUES('database_version','STRING','1.2.6','数据库版本');
