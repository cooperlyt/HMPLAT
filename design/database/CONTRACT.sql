...
DROP TABLE IF EXISTS CONTRACT.COMMIT_FILE;
...
DROP TABLE IF EXISTS CONTRACT.OLD_HOUSE_MONEY;
DROP TABLE IF EXISTS CONTRACT.MONEY_MANAGER;
...
DROP TABLE IF EXISTS CONTRACT.MESSAGE_BOX;
DROP TABLE IF EXISTS CONTRACT.NUMBER_POOL;
DROP TABLE IF EXISTS CONTRACT.NUMBER_SEQUENCE;
DROP TABLE IF EXISTS CONTRACT.PROJECT_NUMBER_POOL;
DROP TABLE IF EXISTS CONTRACT.PUBLIC_INFO;
...
CREATE TABLE CONTRACT.MESSAGE_BOX
(
	ID bigint NOT NULL AUTO_INCREMENT,
	CONTENT varchar(1024) NOT NULL,
	CONNECT_ID varchar(32),
	READ_MARK boolean NOT NULL,
	CREATE_TIME datetime NOT NULL,
...
(
	...
	SELLER_POOL_TYPE varchar(32) NOT NULL,
	PRIMARY KEY (ID)
) ENGINE = InnoDB DEFAULT CHARACTER SET utf8;
...
CREATE TABLE CONTRACT.PUBLIC_INFO
(
	ID bigint NOT NULL AUTO_INCREMENT,
	TYPE varchar(16) NOT NULL,
