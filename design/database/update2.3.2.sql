...
ALTER TABLE HOUSE_OWNER_RECORD.OLD_SELL_CONTRACT_INFO ADD TAX_TYPE varchar(5) NULL;

INSERT DB_PLAT_SYSTEM.REPORT (ID, NAME, DESCRIPTION, PAGE) VALUE ('87','存量房买卖合同','存量房买卖合同','/report/fcfcc/FcOldSellContractInfo.xhtml');

UPDATE DB_PLAT_SYSTEM.SYSTEM_PARAM set VALUE='2.3.2' where ID='database_version';