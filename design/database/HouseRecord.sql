...
(
	...
	-- 倒库导入原库的NO
	BUSSINESS_ID VARCHAR(32) NOT NULL COMMENT 'BUSSINESS_ID',
...
(
	...
	PROJECT VARCHAR(32) COMMENT 'PROJECT',
...
(
	...
	MAPPING_CORP_CODE VARCHAR(32) COMMENT '测绘机构编号',
	MAPPING_CORP VARCHAR(100) COMMENT '测绘机构',
