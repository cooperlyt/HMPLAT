...
DROP TABLE IF EXISTS HOUSE_OWNER_RECORD.32PROJECT_SELL_CARD;
...
DROP TABLE IF EXISTS HOUSE_OWNER_RECORD.OTHER_REGISTE;
DROP TABLE IF EXISTS HOUSE_OWNER_RECORD.REASON;
DROP TABLE IF EXISTS HOUSE_OWNER_RECORD.SALE_INFO;
DROP TABLE IF EXISTS HOUSE_OWNER_RECORD.UPLOAD_FILES;
...
CREATE TABLE HOUSE_OWNER_RECORD.32PROJECT_SELL_CARD
(
	...
	PRIMARY KEY (ID)
) ENGINE = InnoDB COMMENT = '32PROJECT_SELL_CARD' DEFAULT CHARACTER SET utf8;
...
ALTER TABLE HOUSE_OWNER_RECORD.32PROJECT_SELL_CARD
