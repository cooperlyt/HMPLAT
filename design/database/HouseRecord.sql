...
DROP TABLE IF EXISTS HOUSE_OWNER_RECORD.REGISTER_PROPERTY;
...
(
	...
	-- 倒库导入原库的NO
	BUSINESS_ID VARCHAR(32) NOT NULL COMMENT 'BUSINESS_ID',
	POOL_MEMO VARCHAR(10) COMMENT '共有情况',
	HOUSE_PROPERTY VARCHAR(20) COMMENT '产别',
	HOUSE_FROM VARCHAR(20) COMMENT '产权来源',
	PRIMARY KEY (ID)
) ENGINE = InnoDB COMMENT = '登记属性信息' DEFAULT CHARACTER SET utf8;
