...
DROP TABLE HOUSE_OWNER_RECORD.RECORD_AND_CARD;
DROP TABLE HOUSE_OWNER_RECORD.RECORD_AND_POOLOWNER;
...
(
	...
	MASTER_OWNER VARCHAR(32) COMMENT '产权人',
	LAND_INFO VARCHAR(32) NOT NULL COMMENT 'LAND_INFO',
	-- 倒库导入原库的NO
	LAST_BUSINESS VARCHAR(32) NOT NULL COMMENT 'LAST_BUSINESS',
	PRIMARY KEY (ID)
...
CREATE TABLE HOUSE_OWNER_RECORD.RECORD_AND_POOLOWNER
(
	RECORD_ID VARCHAR(32) NOT NULL COMMENT '档案',
	POOL_OWNER VARCHAR(32) NOT NULL COMMENT '共有人',
	PRIMARY KEY (RECORD_ID, POOL_OWNER)
) ENGINE = InnoDB COMMENT = '共有权人' DEFAULT CHARACTER SET utf8;


CREATE TABLE HOUSE_OWNER_RECORD.RECORD_AND_CARD
(
	CARD VARCHAR(32) NOT NULL COMMENT '证',
	RECORD VARCHAR(32) NOT NULL COMMENT '档案',
	PRIMARY KEY (CARD, RECORD)
) ENGINE = InnoDB COMMENT = '证' DEFAULT CHARACTER SET utf8;
...
ALTER TABLE HOUSE_OWNER_RECORD.RECORD_AND_CARD
	ADD FOREIGN KEY (CARD)
	REFERENCES HOUSE_OWNER_RECORD.MAKE_CARD (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
...
ALTER TABLE HOUSE_OWNER_RECORD.RECORD_AND_POOLOWNER
