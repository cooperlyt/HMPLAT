...
DROP TABLE IF EXISTS HOUSE_INFO.SELL_SHOW_IMG;
DROP TABLE IF EXISTS HOUSE_INFO.COMPANY_SELL_INFO;
DROP TABLE IF EXISTS HOUSE_INFO.SELL_PROXY_PERSON;
DROP TABLE IF EXISTS HOUSE_INFO.OLD_HOUSE_SELL;
DROP TABLE IF EXISTS HOUSE_INFO.HOUSE_SELL_INFO;
