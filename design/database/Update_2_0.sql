...
ALTER TABLE HOUSE_OWNER_RECORD.PROJECT_SELL_INFO ADD CREATE_MONEY DECIMAL(19,4) NULL;
ALTER TABLE HOUSE_OWNER_RECORD.PROJECT_SELL_INFO ADD COMPLATE_DATE DATETIME NULL;
