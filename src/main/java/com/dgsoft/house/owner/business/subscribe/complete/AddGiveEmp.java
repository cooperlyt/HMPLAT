 ...
 */
@Name("addGiveEmp")
public class AddGiveEmp implements TaskCompleteSubscribeComponent {
    ...
    public void complete() {
        for (BusinessEmp businessEmp:ownerBusinessHome.getInstance().getBusinessEmps()){
            if (businessEmp.getType().equals(BusinessEmp.EmpType.GIVE_EMP)){
        ...
        BusinessEmp businessEmp = new BusinessEmp(BusinessEmp.EmpType.GIVE_EMP);
