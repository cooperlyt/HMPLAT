 ...
 * 添加质检人
 */
@Name("addQualityCheckEmp")
public class AddQualityCheckEmp implements TaskCompleteSubscribeComponent {
    ...
    public void complete() {
        for (BusinessEmp businessEmp:ownerBusinessHome.getInstance().getBusinessEmps()){
            if (businessEmp.getType().equals(BusinessEmp.EmpType.QUALITY_CHECK_EMP)){
        ...
        BusinessEmp businessEmp = new BusinessEmp(BusinessEmp.EmpType.QUALITY_CHECK_EMP);
