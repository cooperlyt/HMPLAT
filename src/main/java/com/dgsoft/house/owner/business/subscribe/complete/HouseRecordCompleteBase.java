 ...
 */
public abstract class HouseRecordCompleteBase implements TaskCompleteSubscribeComponent {
    ...
    protected abstract String getSearchKey(HouseBusiness houseBusiness);

    protected abstract String getDisplay(HouseBusiness houseBusiness);

    protected void doComplete(HouseRecord houseRecord){
    ...
    public void complete() {
        ...
        if (!ownerBusinessHome.getInstance().getType().equals(BusinessInstance.BusinessType.NORMAL_BIZ)) {
            ...
            for (HouseBusiness houseBusiness : ownerBusinessHome.getInstance().getHouseBusinesses()) {
                ...
                if (houseRecord == null) {
                    ownerEntityLoader.getEntityManager().persist(new HouseRecord(house,lastStatus,getSearchKey(houseBusiness),getDisplay(houseBusiness)));
                } else {
                    houseRecord.setBusinessHouse(house);
                    houseRecord.setHouseStatus(lastStatus);
                    houseRecord.setSearchKey(getSearchKey(houseBusiness));
                    houseRecord.setDisplay(getDisplay(houseBusiness));
                }

                doComplete(houseRecord);
