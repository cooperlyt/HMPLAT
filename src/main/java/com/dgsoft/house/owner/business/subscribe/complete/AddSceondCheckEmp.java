...
/**
 * Created by wxy on 2017-08-30.
 */
@Name("addSceondCheckEmp")
public class AddSceondCheckEmp implements TaskCompleteSubscribeComponent {
    ...
    public void complete() {
        ...
        for (BusinessEmp businessEmp:ownerBusinessHome.getInstance().getBusinessEmps()){
            if (businessEmp.getType().equals(BusinessEmp.EmpType.SECOND_CHECK)){
        ...
        BusinessEmp businessEmp = new BusinessEmp(BusinessEmp.EmpType.SECOND_CHECK);
