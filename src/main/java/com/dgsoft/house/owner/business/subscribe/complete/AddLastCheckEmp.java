 ...
 * 添加审批人信息
 */
@Name("addLastCheckEmp")
public class AddLastCheckEmp implements TaskCompleteSubscribeComponent {
    ...
    public void complete() {
        for (BusinessEmp businessEmp:ownerBusinessHome.getInstance().getBusinessEmps()){
            if (businessEmp.getType().equals(BusinessEmp.EmpType.LAST_CHECK_EMP)){
        ...
        BusinessEmp businessEmp = new BusinessEmp(BusinessEmp.EmpType.LAST_CHECK_EMP);
