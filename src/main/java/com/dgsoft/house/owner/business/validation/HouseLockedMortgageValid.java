...
/**
 * Created by wxy on 2017-03-22.
 *  有抵押预警能启动抵押的业务
 */
@Name("houseLockedMortgageValid")
public class HouseLockedMortgageValid extends BusinessHouseValid {
    ...
    public ValidResult valid(BusinessHouse businessHouse) {
        ...
        if (lockedHouseCode.size() > 0) {
            for (LockType lockType:lockedHouseCode){
                ...
                if (!lockType.equals(LockType.CANT_SALE) && !lockType.equals(LockType.MORTGAGE_REEG) && !lockType.equals(LockType.PREAPRE_MORTGAGE)){
