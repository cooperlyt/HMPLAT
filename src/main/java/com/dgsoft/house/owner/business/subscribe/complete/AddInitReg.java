...
public class AddInitReg implements TaskCompleteSubscribeComponent {
    ...
    public void complete() {
        ...
        for (HouseBusiness houseBusiness:ownerBusinessHome.getInstance().getHouseBusinesses()){
            houseBusiness.getAddHouseStatuses().add(new AddHouseStatus(HouseInfo.HouseStatus.INIT_REG,houseBusiness));
            ...
            houseStatusList.add(HouseInfo.HouseStatus.INIT_REG);
