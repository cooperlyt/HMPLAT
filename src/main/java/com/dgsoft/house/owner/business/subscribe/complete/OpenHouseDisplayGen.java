 ...
 */
@Name("openHouseDisplayGen")
public class OpenHouseDisplayGen implements TaskCompleteSubscribeComponent {
    ...
    public void complete() {
        ...
        for(HouseBusiness bh: ownerBusinessHome.getInstance().getHouseBusinesses()){
            ...
            businessDisplay.addData(DescriptionDisplay.DisplayStyle.LABEL, "解封申请人");
