...
public class BusinessPersion implements java.io.Serializable,PersonEntity{
    ...
    public enum PersionType{
        OWNER_ENTRUST,PRE_SALE_ENTRUST,TERRIBLE_RELATION,CORRECT,MORTGAGE,MORTGAGE_OBLIGEE,
        RECORD_OWNER,MORTGAGE_OBLIGOR,MORTGAGE_PROJECT,MORTGAGE_OBLIGEE_OLD,LESSEE_PEOPLE,LESSOR_PEOPLE;
    }
