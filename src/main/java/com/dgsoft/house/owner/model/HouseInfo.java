...
public class HouseInfo implements java.io.Serializable {
	...
	private Set<BusinessHouse> businessHousesForStart = new HashSet<BusinessHouse>(0);
	private Set<HouseState> houseStates = new HashSet<HouseState>(0);
	private Set<BusinessHouse> businessHousesForAfter = new HashSet<BusinessHouse>(0);
	...
	public Set<BusinessHouse> getBusinessHousesForStart() {
		return this.businessHousesForStart;
	}

	public void setBusinessHousesForStart(
			Set<BusinessHouse> businessHousesForStart) {
		this.businessHousesForStart = businessHousesForStart;
	}
	...
	public Set<BusinessHouse> getBusinessHousesForAfter() {
		return this.businessHousesForAfter;
	}

	public void setBusinessHousesForAfter(
			Set<BusinessHouse> businessHousesForAfter) {
		this.businessHousesForAfter = businessHousesForAfter;
	}
