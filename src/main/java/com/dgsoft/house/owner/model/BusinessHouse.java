...
//    }
    ...
    @Transient
    public PowerPerson getOldMainContractPerson(){
        List<PowerPerson> result = getPowerPersonListByType(PowerPerson.PowerPersonType.CONTRACT,true);
        if (result.isEmpty()){
            return null;
        }else{
            return result.get(0);
    ...
    @Transient
    public List<PowerPerson> getMainPreparePersonList(){
        return getPowerPersonListByType(PowerPerson.PowerPersonType.PREPARE,false);
    }
    ...
    @Transient
    public PowerPerson getMainPreparePerson(){
        List<PowerPerson> result = getPowerPersonListByType(PowerPerson.PowerPersonType.PREPARE,false);
        if (result.isEmpty()){
            return null;
        }else{
            return result.get(0);
