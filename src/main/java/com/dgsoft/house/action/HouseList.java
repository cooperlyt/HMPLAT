...
public class HouseList extends HouseEntityQuery<House> {
    ...
    private static final String EJBQL = "select house from House house " +
            ...
            "left join fetch house.houseOwnerByOwnerId";
    ...
    private static final String[] RESTRICTIONS = {
            ...
            "lower(house.build.project.developer.name) like lower('%',#{projectSearchCondition.developerName},'%')",
            ...
            "house.build.landBlockCode = #{buildSearchCondition.landBlockCode}",
            ...
            "lower(house.doorNo) like lower(concat('%',#{houseSearchCondition.doorNo},'%')",
