 ...
 *
 */
public abstract class TestQuery<T, E>
        extends PersistenceController<T> //TODO: extend MutableController!
{
     ...
     *
     * Delegates to {@link org.jboss.seam.faces.DataModels#getDataModel(Query)}
     *
     */
    @Transactional
    ...
    public List<String> getRestrictionExpressionStrings()
    {
        ...
        for (Expressions.ValueExpression restriction : getRestrictions())
        {
