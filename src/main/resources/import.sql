...
INSERT DB_PLAT_SYSTEM.SYSTEM_PARAM(ID,TYPE, VALUE, MEMO) VALUES ('MessageServerAddress','STRING','http://127.0.0.1:8090/message/notify?source=FC','消息服务器地址');
...
INSERT INTO ROLE (ID, NAME, DESCRIPTION, PRIORITY)  VALUES('total.export.saleTotal','房地产交易情况表','房地产交易情况表',5);
...
INSERT INTO ROLE(ID, NAME, DESCRIPTION, PRIORITY) VALUES ('total.export.tempSql','临时查询统计','临时查询统计',7);

INSERT INTO ROLE(ID, NAME, DESCRIPTION, PRIORITY) VALUES ('total.export.storeHouse','库存商品房统计','库存商品房统计',8);
