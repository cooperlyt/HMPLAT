...
INSERT INTO FUNCTION (ID, NAME, CATEGORY, ICON, LOCATION, BANNER, PRIORITY, MEMO,NEED_CONVERSATION) VALUES ('house.businessSearch','阶段查询','DAY_WORK','','/func/house/owner/BusinessSearch.xhtml','',1,'',b'0');
